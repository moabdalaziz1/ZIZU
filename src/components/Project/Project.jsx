...
const Project = ({ item }) => {
  const { initialSecondary, whileInView, transition } =
  ...
  return (
    ...
    >
      <div className="project">
        <div className="project-name py-2">{item.title}</div>
        <a
          href={item.pageLink}
          target="_blank"
          rel="noreferrer"
        ...
        <div className="project-skills p-3">
          ...
          <div className="project-Details">
            <p>
              Project Type: <span>{item.for}</span>
            </p>
            <p>
              Completion Date: <span>{item.date}</span>
            </p>
          </div>
        </div>
